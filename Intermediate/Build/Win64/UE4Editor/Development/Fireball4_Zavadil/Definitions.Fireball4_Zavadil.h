...
#define ORIGINAL_FILE_NAME "UE4Editor-Fireball4_Zavadil.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Fireball4_Zavadil
#define DEPRECATED_FORGAME DEPRECATED
#define FIREBALL4_ZAVADIL_API DLLEXPORT
